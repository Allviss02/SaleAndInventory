...
?>
            ...
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-primary">Customer's more detail</h4>
                    ...
                    <a href="customer_view_logistics.php" type="button" class="btn btn-primary bg-gradient-primary btn-block"> <i class="fas fa-flip-horizontal fa-fw fa-share"></i> Back </a>
            <div class="card-body">
