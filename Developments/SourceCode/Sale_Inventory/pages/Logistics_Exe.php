            ...
            <div class="col-md-12 mb-3">
              <div class="card border-left-danger shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-0">
                      <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Delivery</div>
                      <div class="h6 mb-0 font-weight-bold text-gray-800">
                        <?php 
                        $query = "SELECT COUNT(OrderMaster_ID) 
                                    FROM OrderMaster WHERE Approval = 'approval'";
                        $result = mysqli_query($conn, $query);
                        while ($row = mysqli_fetch_array($result)) {
                            echo "$row[0]";
                          }
                    ...
                    <div class="card shadow h-100">
                      <div class="card-body">
                        ...
                        <div class="panel-body">
                            ...
                            <!-- /.list-group -->
                            <a href="product_view_logistics.php" class="btn btn-default btn-block">View All Products</a>
                        </div>
                        <!-- /.panel-body -->
